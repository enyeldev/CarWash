    ...
    <footer id="contacto" className="border-t border-border bg-background py-12">
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground">
              La plataforma todo-en-uno para gestionar tu carwash de forma inteligente y eficiente.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-sm text-muted-foreground">© 2025 WashPro. Todos los derechos reservados.</p>
